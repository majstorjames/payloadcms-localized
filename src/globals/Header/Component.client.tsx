  ...
  return (
    <div>
      <header
        ...
        className="fixed top-2 left-3 right-5 z-[50] backdrop-blur-lg shadow-md rounded-3xl pl-3 pr-5 py-4 flex justify-between items-center text-foreground bg-background/50 supports-backdrop-blur:bg-background/50"
