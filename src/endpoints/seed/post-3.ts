...
export const post3_hr: Partial<Post> = {
  slug: 'dollar-and-sense',
  slugLock: false,
  _status: 'published',
  // @ts-ignore
        ...
        },
        {
          ...
          children: [
            ...
            },
            {
              ...
              mode: 'normal',
              style: '',
              text: 'Uronite u njegove nijanse, gdje se strategija susreće s intuicijom u golemom moru financija.',
              version: 1,
            },
          ],
          direction: 'ltr',
  ...
  meta: {
    description: `Novac nije samo valuta; to je jezik. Uronite u njegove nijanse, gdje se strategija susreće s intuicijom u golemom moru financija.`,
    // @ts-ignore
    image: '{{IMAGE_1}}',
    title: 'Dolar i Logika: Financijska Prognoza',
  },
