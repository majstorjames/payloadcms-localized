...
// import { recipe1_en,recipe1_hr,recipe2_en,recipe2_hr,recipe3_en,recipe3_hr } from './recipes'
...
//   const recipesCategory = await payload.create({
//     collection: 'categories',
//     locale: 'en',
//     data: {
//       title: 'Recipes',
...
// // console.log('Creating recipe with data:', recipe1_en(demoAuthorID as number, image1ID as number))

// // const recipe1Doc = await payload.create({
// //   collection: 'recipes',
// //   data: {
// //     ...recipe1_en(demoAuthorID as number, image1ID as number),
// //     categories: [recipesCategory.id],
// //   },
// //   locale: 'en',
// //   req,
...
// //   id: recipe1Doc.id,
// //   data: {
// //     ...recipe1_hr(image1ID as number),
// //     authors: [demoAuthorID as number],
// //     categories: [recipesCategory.id],
// //   },
// //   locale: 'hr',
// //   req,
...
// //   collection: 'recipes',
// //   data: {
// //     ...recipe2_en(demoAuthorID as number, image2ID as number),
// //     categories: [recipesCategory.id],
// //   },
// //   locale: 'en',
// //   req,
...
// //   collection: 'recipes',
// //   data: {
// //     ...recipe3_en(demoAuthorID as number, image3ID as number),
// //     categories: [recipesCategory.id],
// //   },
// //   locale: 'en',
// //   req,
...
// //   collection: 'recipes',
// //   id: recipe1Doc.id,
// //   data: { relatedRecipes: [recipe2Doc.id, recipe3Doc.id] },
// //   req,
// // })
...
// //   collection: 'recipes',
// //   id: recipe2Doc.id,
// //   data: { relatedRecipes: [recipe1Doc.id, recipe3Doc.id] },
// //   req,
// // })
...
// //   collection: 'recipes',
// //   id: recipe3Doc.id,
// //   data: { relatedRecipes: [recipe1Doc.id, recipe2Doc.id] },
// //   req,
// // })
// // // #endregion
...
//   name,
// }: {
//   en: (authorID: number, imageID: number) => RecipeInput
//   hr: (imageID: number) => RecipeInput
//   imageID: number | string
//   categoryID: number | string
//   name: string
// }) => {
//   const enData = {
//     ...en(demoAuthorID as number, imageID as number),
//     categories: [categoryID],
//   }

//   console.log(`Creating recipe "${name}" (en):`, enData)

//   const created = await payload.create({
//     collection: 'recipes',
//     categories:  [recipesCategory.id as number | Category],
//     data: enData,
//     locale: 'en'
//     req,
//   })
...
//   const hrData = {
//     ...hr(imageID as number ),
//     authors: [demoAuthorID as number],
//     categories:  [recipesCategory.id as number | Category],
//     //[categoryID],
//   }

//   console.log(`Updating recipe "${name}" (hr):`, hrData)
...
// const recipe1Doc = await createRecipe({
//   en: recipe1_en,
//   hr: recipe1_hr,
//   imageID: image1ID,
...
// const recipe2Doc = await createRecipe({
//   en: recipe2_en,
//   hr: recipe2_hr,
//   imageID: image2ID,
//   categoryID: recipesCategory.id,
...
// const recipe3Doc = await createRecipe({
//   en: recipe3_en,
//   hr: recipe3_hr,
//   imageID: image3ID,
//   categoryID: recipesCategory.id,
